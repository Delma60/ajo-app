...
export async function GET(
  ...
  try {
    ...
    const pausedMemberIds = (data.pausedMemberIds as string[]) ?? [];
    const pausedSet = new Set(pausedMemberIds);
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        invitePermission: (data.invitePermission as string) ?? "admin",
